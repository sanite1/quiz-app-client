...
const Countdown = ({ countdownTime, timeOver, setTimeTaken }) => {
  ...
  return (
    <Button.Group size="medium" basic floated="right">
      <Popup
        content="Hours"
        trigger={<Button style={{fontWeight: 700}} active>{hours}</Button>}
        position="bottom left"
      />
      <Popup
        content="Minutes"
        trigger={<Button style={{fontWeight: 700}} active>{minutes}</Button>}
        position="bottom left"
      />
      <Popup
        content="Seconds"
        trigger={<Button style={{fontWeight: 700}} active>{seconds}</Button>}
        position="bottom left"
      />
    </Button.Group>
  );
